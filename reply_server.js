...
① 에센셜 리제너레이터 핸드크림 (50ml, 실내용)
   - NMN을 담은 고기능성 핸드크림. 올리브영 1,400개 매장·2025 바디케어 1위·올영 어워즈. (“국내 유일” 같은 표현은 쓰지 않는다.)
...
② 어드밴스드 리제너레이터 핸드크림 (30ml, SPF20/PA++, 실외용)
   ...
   - 핵심 성분: NMN(99.9%), 나이아신아마이드. 자외선 차단을 위해 SPF20이 들어 있다(성분명은 언급하지 말고 “SPF20으로 자외선 차단” 정도로만 설명한다).
