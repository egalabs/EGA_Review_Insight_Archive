...
⑥ EGA 선 프로텍터 (UV IN&OUT Protector, 얼굴 선크림·신제품)
   - NMN 함유 데일리 선크림. SPF50+ 수준의 자외선 차단에 더해, 백탁 없이 로션처럼 발리고 쿨링감이 있다.
   - 매일 기초 단계에서 바르기 좋고, 화장이 잘 먹는다는 반응. 여름·자외선 시즌 데일리로 추천.

[연관 제품 추천 로직 — 1~2개만, 자연스럽게]
...
- 손 자외선·운전·골프 니즈 → 어드밴스드 핸드크림(자외선 차단).
- 억지로 여러 개 나열하지 않는다.
